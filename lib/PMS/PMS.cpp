    ...
    default:
      ...
      else if (_index == _frameLen + 2 + 1)
      {
        ...
        if (_calculatedChecksum == _checksum)
        {
          ...
          // Dust
          _data->PART_0_3_UM = makeWord(_payload[12], _payload[13]);
          _data->PART_0_3_UM = makeWord(_payload[14], _payload[15]);
          _data->PART_1_0_UM = makeWord(_payload[16], _payload[17]);
        }
